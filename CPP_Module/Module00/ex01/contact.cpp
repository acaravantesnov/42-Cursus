...
/*   Updated: 2022/03/17 23:36:45 by acaravan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "contact.hpp"

std::string &contact::get_firstName() {return (_firstName);}
std::string &contact::get_lastName() {return (_lastName);}
std::string &contact::get_nickName() {return (_nickName);}
std::string &contact::get_phone() {return (_phone);}
std::string	&contact::get_darkestSecret() {return (_darkestSecret);}
