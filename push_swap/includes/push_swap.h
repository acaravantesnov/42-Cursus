...
/*   Updated: 2021/12/26 14:26:01 by acaravan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_3digits(long *stackA, long *stackB, int ndigitsA);
void	sort_5digits(long *stackA, long *stackB, int ndigitsA);
void	sort_100digits(long *stackA, long *stackB, int ndigitsA);
void	sort_500digits(long *stackA, long *stackB, int ndigitsA);
